...
using TCP/IP, especially if custom protocols are required.}
  ...
  s.files = [%q{README.md}, %q{docs/DocumentationGuidesIndex.md}, %q{docs/GettingStarted.md}, %q{docs/old/ChangeLog}, %q{docs/old/DEFERRABLES}, %q{docs/old/EPOLL}, %q{docs/old/INSTALL}, %q{docs/old/KEYBOARD}, %q{docs/old/LEGAL}, %q{docs/old/LIGHTWEIGHT_CONCURRENCY}, %q{docs/old/PURE_RUBY}, %q{docs/old/RELEASE_NOTES}, %q{docs/old/SMTP}, %q{docs/old/SPAWNED_PROCESSES}, %q{docs/old/TODO}, %q{ext/extconf.rb}, %q{ext/fastfilereader/extconf.rb}]
